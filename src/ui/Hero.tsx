...
export default function Hero() {
  return (
    <>
      <section>
        <div className="bg-[url('/src/assets/capagpstransfer.webp')] bg-fill bg-no-repeat h-[430px] md:h-[520px] relative bg-cover bg-center"></div>
        <div className="flex flex-col items-center text-center bg-white p-12 md:max-w-[920px] md:absolute md:left-[50%] md:top-[50%] md:-translate-x-1/2 md:-translate-y-1/2 md:mt-80">
      ...
      <div className="mt-24 md:mt-96 mb-48">
