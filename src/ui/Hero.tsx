...
export default function Hero() {
  return (
    <>
      <section className="bg-[url('/src/assets/capagpstransfer.webp')] bg-fill bg-no-repeat h-[540px] relative bg-cover">
        <div className="flex flex-col items-center text-center bg-white max-w-[1020px] absolute -bottom-72 left-1/2 transform -translate-x-1/2 p-12 rounded-lg drop-shadow-2xl">
      ...
      <div className="mt-96 mb-48">
        <div className="flex flex-col items-center justify-center text-center max-w-[680px] m-auto">
          <svg
