export default function CTA() {
  return (
    <div className="bg-[url('/src/assets/Praia-Arraial.png')] bg-fill bg-no-repeat h-[430px] relative bg-cover bg-center flex flex-col justify-center items-center text-center p-8 gap-16">
      ...
      <div>
        <a href="https://api.whatsapp.com/send?phone=5573998344769&text=Ol%C3%A1%2C%20vim%20pelo%20site%2C%20gostaria%20de%20saber%20mais%20sobre%20o%20transfer...">
          <button className="bg-white text-black flex fill-black py-4 px-6 justify-center items-center gap-2">
