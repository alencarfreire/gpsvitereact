...
export default function Destinos() {
  ...
  const dataDestinos: dataDestinos[] = [
    ...
    },
    {
      ...
      image: "./src/assets/Trancoso.webp",
    },
    {
      title: "Caraíva",
      description:
    ...
    },
    {
      ...
      image: "./src/assets/aeroportoportoseguro.png",
    },
    {
      ...
      image: "./src/assets/placaportoseguro.png",
    }
  ];

  return (
    <section className="bg-white px-8 py-8 text-center">
      <h3 className="text-3xl font-bold mb-24 text-[#F2444A]" id="destinos">Para onde você precisa ir?</h3>
